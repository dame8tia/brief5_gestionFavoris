<?php
     function add($query, $db){
        $db = $db ;

        // traitement particulier pour ces 3 variables qui sont injectées dans la req SQL comme les valeurs de clé étrangères
        ...
        if (!$resultat_exec)
        {
            $errorMessage = "Invalid Query ".$query->error ;
        }
    }
?>